  ...
  render () {
    return (
      <React.Fragment>
        ...
        <p>This web app was created by <a href="https://thinkingmachin.es">Thinking Machines Data Science</a>, a data science consultancy that builds data systems for humans. Our projects include data transformation for major enterprises and on civic data problems for the public sector.</p>
